...
comment_field = ["brand", "series", "spec", "dateNtime", "web", "url", "advantage", "shortcoming", "space", "power", "operation", "oilwear", "comfort", "appearance", "decoration", "costperformance", "failure", "maintenance", "other", "upvote", "downvote", "respond"]
...
dateHandler="0000-00-00 00:00:00"
dateHandler2="0000-00-00 00:00:00"
...
def crawl_comment(web_name, brand, series, spec_name, url_base):
	...
	while(flag):
		...
		for item in soup.body.find_all("div", class_="mouthcon"):
			...
			record["dateNtime"] = date[-1].text.strip()
